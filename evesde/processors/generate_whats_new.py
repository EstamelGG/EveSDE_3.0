...
import evesde.processors.item_changes_analyzer as item_changes_analyzer
...
def get_current_build_numbers(config: Dict[str, Any]):
    ...
    sde_jsonl_path = project_root / config["paths"]["sde_input"]
...
def main():
    ...
    try:
        ...
        current_jsonl_path = project_root / config["paths"]["sde_input"]
